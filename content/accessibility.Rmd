...
- https://www.meetup.com/cities/us/va/herndon/
...
Andradge exclusively uses the RStudio IDE for R coding and Spyder (Scientific Python Development Environment) - a free integrated development environment (IDE) that is included with Anaconda. It is widely accepted that RStudio is not compatible with the most widely used screen reader tools. We provide explicit confirmation that courses make use of technology that may or may not supports screen readers on both booking pages and booking confirmation emails.  If you have concerns or questions regarding live coding, contact us.  We can work together to make adaptations for your needs. 
